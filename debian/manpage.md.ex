% mohanxlsx(SECTION) | User Commands
%
% "June 19 2026"
...
mohanxlsx - program to do something

# SYNOPSIS

**mohanxlsx** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**mohanxlsx** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **mohanxlsx** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**mohanxlsx** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    mohanxlsx. See **foo.conf**(5) for further details.
...
**mohanxlsx** provides some return codes, that can be used in scripts:
...
Hoho Sd44 <sd44sd44@yeah.net>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Hoho Sd44
